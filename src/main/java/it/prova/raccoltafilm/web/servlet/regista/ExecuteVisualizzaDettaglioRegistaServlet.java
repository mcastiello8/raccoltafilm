...
@WebServlet("/ExecuteVisualizzaDettaglioRegistaServlet")
public class ExecuteVisualizzaDettaglioRegistaServlet extends HttpServlet {
		private static final long serialVersionUID = 1L;
	       
		private RegistaService registaService;
		
		public ExecuteVisualizzaDettaglioRegistaServlet() {
